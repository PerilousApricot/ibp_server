...
struct osd_fs_fd_s {
  ...
  chksum_t chksum;
  pigeon_coop_t *my_range_coop;
  pigeon_coop_hole_t my_range_slot;
  pigeon_coop_hole_t my_slot;
  int timestamp;
};
...
//  osd_off_t *read_range_list;  //** List of host Read block ranges
  pigeon_coop_t *read_range_list;
//  osd_off_t *write_range_list;  //** List of host Write block ranges
  pigeon_coop_t *write_range_list;
...
//    osd_fs_object_t *obj_list;
    pigeon_coop_t *obj_list;
//    osd_fs_fd_t     *fd_list;
    pigeon_coop_t *fd_list;
    apr_hash_t *obj_hash;
...
int fs_associate_id(osd_t *d, int id, char *fname);
